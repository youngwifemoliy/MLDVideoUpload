//
//  MLDSimpleNetworking.swift
//  JJStudy
//
//  Created by Moliy on 2019/7/6.
//  Copyright © 2019 Moliy. All rights reserved.
//

import Foundation

class MLDSimpleNetworking {

    static let sharedInstance = MLDSimpleNetworking()
...
//                    MLDLog.error("sample networking requet failt: JSON could not be serialized because input data was nil.")
